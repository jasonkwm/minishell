...
/*   Updated: 2022/09/11 18:51:32 by jakoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	parse_quote(char *str, t_toke_var *s, t_node **cur_node);
void	parse_arg(char *str, t_toke_var *s, t_node **cur_node);
...
void	tokenize(char *str, t_node	**list)
{
	t_toke_var		s;
	t_node			*cur_node;
